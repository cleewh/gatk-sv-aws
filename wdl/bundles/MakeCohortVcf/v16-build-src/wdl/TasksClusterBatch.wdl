...
task SVCluster {
    ...
    command <<<
        ...
        # HealthOmics fix: Index intermediate VCFs that lack .tbi indexes
        # SVCluster requires .tbi indexes for all input VCFs
        for vcf_file in $(awk "{print \$2}" arguments.txt); do
